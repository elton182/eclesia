...
/**
 * Remove o módulo Escalas genéricas (SPEC-007). Agenda fica em Eventos + Calendário.
 * Idempotente para tenants que ainda tenham as tabelas da migration antiga.
 */
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('escala_tipos')) {
            return;
        }
